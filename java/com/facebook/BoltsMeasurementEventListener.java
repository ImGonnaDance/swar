...
public class BoltsMeasurementEventListener extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        String eventName = new StringBuilder(BOLTS_MEASUREMENT_EVENT_PREFIX).append(intent.getStringExtra(MEASUREMENT_EVENT_NAME_KEY)).toString();
        ...
        for (String key : eventArgs.keySet()) {
            logData.putString(key.replaceAll("[^0-9a-zA-Z _-]", "-").replaceAll("^[ -]*", i.a).replaceAll("[ -]*$", i.a), (String) eventArgs.get(key));
        }
