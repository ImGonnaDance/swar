...
public interface GraphObject {
    ...
    public static final class Factory {
        ...
        public static boolean hasSameId(GraphObject a, GraphObject b) {
            if (a == null || b == null || !a.asMap().containsKey(PeppermintConstant.JSON_KEY_ID) || !b.asMap().containsKey(PeppermintConstant.JSON_KEY_ID)) {
                return false;
            }
            if (a.equals(b)) {
                return true;
            }
            Object idA = a.getProperty(PeppermintConstant.JSON_KEY_ID);
            Object idB = b.getProperty(PeppermintConstant.JSON_KEY_ID);
