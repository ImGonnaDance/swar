...
public final class Utility {
    ...
    class AnonymousClass1 extends AsyncTask<Void, Void, GraphObject> {
        ...
        protected void onPostExecute(GraphObject result) {
            if (result != null) {
                ...
                this.val$context.getSharedPreferences(Utility.APP_SETTINGS_PREFS_STORE, 0).edit().putString(this.val$settingsKey, resultJSON.toString()).apply();
            }
            ...
            for (String parameter : queryString.split("&")) {
                ...
                try {
                    if (keyValuePair.length == 2) {
                        ...
                        params.putString(URLDecoder.decode(keyValuePair[0], UTF8), i.a);
                    }
                } catch (Exception e) {
                    logd(LOG_TAG, e);
                }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    char[] buffer = new char[ModuleConfig.OFFERWALL_MODULE];
                    while (true) {
        ...
        if (cookies != null) {
            for (String cookie : cookies.split(";")) {
                ...
                if (cookieParts.length > 0) {
                    cookieManager.setCookie(domain, new StringBuilder(String.valueOf(cookieParts[0].trim())).append("=;expires=Sat, 1 Jan 2000 00:00:01 UTC;").toString());
                }
            }
    ...
    public static void logd(String tag, Exception e) {
        if (Settings.isDebugEnabled() && tag != null && e != null) {
            Log.d(tag, new StringBuilder(String.valueOf(e.getClass().getSimpleName())).append(": ").append(e.getMessage()).toString());
        }
    }
    ...
    public static void loadAppSettingsAsync(Context context, String applicationId) {
        if (!isNullOrEmpty(applicationId) && !fetchedAppSettings.containsKey(applicationId) && initialAppSettingsLoadTask == null) {
            String settingsKey = String.format(APP_SETTINGS_PREFS_KEY_FORMAT, new Object[]{applicationId});
            initialAppSettingsLoadTask = new AnonymousClass1(applicationId, context, settingsKey);
    ...
    private static FetchedAppSettings parseAppSettingsFromJSON(String applicationId, JSONObject settingsJSON) {
        FetchedAppSettings result = new FetchedAppSettings(settingsJSON.optBoolean(APP_SETTING_SUPPORTS_ATTRIBUTION, false), settingsJSON.optBoolean(APP_SETTING_SUPPORTS_IMPLICIT_SDK_LOGGING, false), settingsJSON.optString(APP_SETTING_NUX_CONTENT, i.a), settingsJSON.optBoolean(APP_SETTING_NUX_ENABLED, false), parseDialogConfigurations(settingsJSON.optJSONObject(APP_SETTING_DIALOG_CONFIGS)));
    ...
    private static GraphObject getAppSettingsQueryResponse(String applicationId) {
        ...
        appSettingsParams.putString(APPLICATION_FIELDS, TextUtils.join(i.b, APP_SETTING_FIELDS));
    ...
    private static Map<String, Map<String, DialogFeatureConfig>> parseDialogConfigurations(JSONObject dialogConfigResponse) {
        ...
        if (dialogConfigResponse != null) {
            JSONArray dialogConfigData = dialogConfigResponse.optJSONArray(PeppermintConstant.JSON_KEY_DATA);
    ...
    public static String getHashedDeviceAndAppID(Context context, String applicationId) {
        ...
        return sha1hash(new StringBuilder(String.valueOf(androidId)).append(applicationId).toString());
    }
    ...
    public static String getActivityName(Context context) {
        if (context == null) {
            return ActiveUserProperties.AGREEMENT_SMS_VALUE_UNKNOWN;
        }
