...
public class Response {
    ...
    Response(Request request, HttpURLConnection connection, FacebookRequestError error) {
        this(request, connection, null, null, null, $assertionsDisabled, error);
    }
    ...
    public String toString() {
        ...
        try {
            ...
            objArr[0] = Integer.valueOf(this.connection != null ? this.connection.getResponseCode() : SelectTarget.TARGETING_SUCCESS);
    ...
    static List<Response> fromHttpConnection(HttpURLConnection connection, RequestBatch requests) {
        ...
        try {
            ...
            createResponsesFromStream = createResponsesFromStream(stream, connection, requests, $assertionsDisabled);
        ...
        if ($assertionsDisabled || connection != null || isFromCache) {
            ...
            if (numRequests == 1) {
                ...
                try {
                    ...
                    jsonObject.put(CODE_KEY, connection != null ? connection.getResponseCode() : SelectTarget.TARGETING_SUCCESS);
    ...
    private static Response createResponseFromObject(Request request, HttpURLConnection connection, Object object, boolean isFromCache, Object originalResult) throws JSONException {
        ...
        if (object == JSONObject.NULL) {
            return new Response(request, connection, object.toString(), null, isFromCache);
        }
