...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(Resource.R(getApplicationContext(), "R.layout.com_facebook_login_activity_layout"));
        ...
        this.authorizationClient.setBackgroundProcessingListener(new BackgroundProcessingListener() {
            public void onBackgroundProcessingStarted() {
                LoginActivity.this.findViewById(Resource.R(LoginActivity.this.getApplicationContext(), "R.id.com_facebook_login_activity_progress_bar")).setVisibility(0);
            }

            public void onBackgroundProcessingStopped() {
                LoginActivity.this.findViewById(Resource.R(LoginActivity.this.getApplicationContext(), "R.id.com_facebook_login_activity_progress_bar")).setVisibility(8);
            }
        });
    }
    ...
    public void onPause() {
        ...
        findViewById(Resource.R(getApplicationContext(), "R.id.com_facebook_login_activity_progress_bar")).setVisibility(8);
    }
