...
public class AppLinkData {
    ...
    public static void fetchDeferredAppLinkData(Context context, String applicationId, CompletionHandler completionHandler) {
        ...
        Settings.getExecutor().execute(new AnonymousClass1(context.getApplicationContext(), applicationId, completionHandler));
    }
    ...
    private static void fetchDeferredAppLinkFromServer(Context context, String applicationId, CompletionHandler completionHandler) {
        ...
        deferredApplinkParams.setProperty(MercuryDefine.TYPE_EVENT, DEFERRED_APP_LINK_EVENT);
    ...
    private static AppLinkData createFromJson(String jsonString) {
        ...
        try {
            ...
            if (appLinkArgsJson.getJSONObject(APPLINK_BRIDGE_ARGS_KEY).getString(BRIDGE_ARGS_METHOD_KEY).equals("applink") && version.equals(a.f)) {
                AppLinkData appLinkData = new AppLinkData();
