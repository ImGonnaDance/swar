...
public class WebDialog extends Dialog {
    ...
    private static class BuilderBase<CONCRETE extends BuilderBase<?>> {
        ...
        public WebDialog build() {
            if (this.session == null || !this.session.isOpened()) {
                ...
                this.parameters.putString(ServerProtocol.FALLBACK_DIALOG_PARAM_APP_ID, this.session.getApplicationId());
    ...
    private class DialogWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView view, String url) {
            ...
            if (url.startsWith(WebDialog.this.expectedRedirectUrl)) {
                ...
                String errorMessage = values.getString(PeppermintConstant.JSON_KEY_ERROR_MSG);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.spinner.setMessage(getContext().getString(Resource.R(getContext(), "R.string.com_facebook_loading")));
    ...
    private void createCrossImage() {
        ...
        this.crossImageView.setImageDrawable(getContext().getResources().getDrawable(Resource.R(getContext(), "R.drawable.com_facebook_close")));
