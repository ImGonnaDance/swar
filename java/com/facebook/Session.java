...
public class Session implements Serializable {
    ...
    class TokenRefreshRequest implements ServiceConnection {
        ...
        private void refreshToken() {
            ...
            requestData.putString(ServerProtocol.DIALOG_PARAM_ACCESS_TOKEN, Session.this.getTokenInfo().getToken());
    ...
    static class TokenRefreshRequestHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            String token = msg.getData().getString(ServerProtocol.DIALOG_PARAM_ACCESS_TOKEN);
        ...
        if (firstObject.getProperty("permission") != null) {
            ...
            for (Entry<String, Object> entry : firstObject.asMap().entrySet()) {
                if (!((String) entry.getKey()).equals("installed") && ((Integer) entry.getValue()).intValue() == 1) {
                    grantedPermissions.add((String) entry.getKey());
                }
            }
        }
    ...
    public final boolean onActivityResult(android.app.Activity r8, int r9, int r10, android.content.Intent r11) {
        /*
        r7 = this;
        r6 = 0;
        r3 = 1;
        r4 = "currentActivity";
        com.facebook.internal.Validate.notNull(r8, r4);
        initializeStaticContext(r8);
        r4 = r7.lock;
        monitor-enter(r4);
        r5 = r7.pendingAuthorizationRequest;	 Catch:{ all -> 0x0030 }
        if (r5 == 0) goto L_0x0019;
    L_0x0011:
        r5 = r7.pendingAuthorizationRequest;	 Catch:{ all -> 0x0030 }
        r5 = r5.getRequestCode();	 Catch:{ all -> 0x0030 }
    ...
    L_0x001c:
        monitor-exit(r4);	 Catch:{ all -> 0x0030 }
        r1 = 0;
        r0 = com.facebook.AuthorizationClient.Result.Code.ERROR;
        if (r11 == 0) goto L_0x003d;
    L_0x0022:
        r4 = "com.facebook.LoginActivity:Result";
        r2 = r11.getSerializableExtra(r4);
        r2 = (com.facebook.AuthorizationClient.Result) r2;
        if (r2 == 0) goto L_0x0033;
    L_0x002c:
        r7.handleAuthorizationResult(r10, r2);
        goto L_0x001b;
    L_0x0030:
        r3 = move-exception;
        monitor-exit(r4);	 Catch:{ all -> 0x0030 }
        throw r3;
    L_0x0033:
        r4 = r7.authorizationClient;
        if (r4 == 0) goto L_0x0048;
    L_0x0037:
        r4 = r7.authorizationClient;
        r4.onActivityResult(r9, r10, r11);
        goto L_0x001b;
    L_0x003d:
        if (r10 != 0) goto L_0x0048;
    L_0x003f:
        r1 = new com.facebook.FacebookOperationCanceledException;
        r4 = "User canceled operation.";
        r1.<init>(r4);
    ...
    L_0x004a:
        ...
        r1.<init>(r4);
    L_0x0051:
        r7.logAuthorizationComplete(r0, r6, r1);
        r7.finishAuthOrReauth(r6, r1);
        goto L_0x001b;
        */
    ...
    public String toString() {
        return "{Session" + " state:" + this.state + ", token:" + (this.tokenInfo == null ? ActiveUserProperties.AGREEMENT_SMS_VALUE_UNKNOWN : this.tokenInfo) + ", appId:" + (this.applicationId == null ? ActiveUserProperties.AGREEMENT_SMS_VALUE_UNKNOWN : this.applicationId) + "}";
    }
    ...
    void extendTokenCompleted(android.os.Bundle r6) {
        ...
        r2 = r5.lock;
        monitor-enter(r2);
        r0 = r5.state;	 Catch:{ all -> 0x004f }
        r1 = $SWITCH_TABLE$com$facebook$SessionState();	 Catch:{ all -> 0x004f }
        r3 = r5.state;	 Catch:{ all -> 0x004f }
        r3 = r3.ordinal();	 Catch:{ all -> 0x004f }
        r1 = r1[r3];	 Catch:{ all -> 0x004f }
        switch(r1) {
    ...
    L_0x0014:
        r1 = TAG;	 Catch:{ all -> 0x004f }
        r3 = new java.lang.StringBuilder;	 Catch:{ all -> 0x004f }
        r4 = "refreshToken ignored in state ";
        r3.<init>(r4);	 Catch:{ all -> 0x004f }
        r4 = r5.state;	 Catch:{ all -> 0x004f }
        r3 = r3.append(r4);	 Catch:{ all -> 0x004f }
        r3 = r3.toString();	 Catch:{ all -> 0x004f }
        android.util.Log.d(r1, r3);	 Catch:{ all -> 0x004f }
        monitor-exit(r2);	 Catch:{ all -> 0x004f }
    L_0x002b:
        return;
    L_0x002c:
        r1 = com.facebook.SessionState.OPENED_TOKEN_UPDATED;	 Catch:{ all -> 0x004f }
        r5.state = r1;	 Catch:{ all -> 0x004f }
        r1 = r5.state;	 Catch:{ all -> 0x004f }
        r3 = 0;
        r5.postStateChange(r0, r1, r3);	 Catch:{ all -> 0x004f }
    L_0x0036:
        r1 = r5.tokenInfo;	 Catch:{ all -> 0x004f }
        r1 = com.facebook.AccessToken.createFromRefresh(r1, r6);	 Catch:{ all -> 0x004f }
        r5.tokenInfo = r1;	 Catch:{ all -> 0x004f }
        r1 = r5.tokenCachingStrategy;	 Catch:{ all -> 0x004f }
        if (r1 == 0) goto L_0x004d;
    L_0x0042:
        r1 = r5.tokenCachingStrategy;	 Catch:{ all -> 0x004f }
        r3 = r5.tokenInfo;	 Catch:{ all -> 0x004f }
        r3 = r3.toCacheBundle();	 Catch:{ all -> 0x004f }
        r1.save(r3);	 Catch:{ all -> 0x004f }
    L_0x004d:
        monitor-exit(r2);	 Catch:{ all -> 0x004f }
        goto L_0x002b;
    L_0x004f:
    ...
    void authorize(AuthorizationRequest request) {
        ...
        this.pendingAuthorizationRequest.loggingExtras.put("try_login_activity", started ? a.e : a.d);
        if (!started && request.isLegacy) {
            this.pendingAuthorizationRequest.loggingExtras.put("try_legacy", a.e);
    ...
    private void open(com.facebook.Session.OpenRequest r8, com.facebook.internal.SessionAuthorizationType r9) {
        ...
        r3 = r7.lock;
        monitor-enter(r3);
        r2 = r7.pendingAuthorizationRequest;	 Catch:{ all -> 0x0036 }
        if (r2 == 0) goto L_0x001d;
    L_0x000d:
        r2 = r7.state;	 Catch:{ all -> 0x0036 }
        r4 = r7.state;	 Catch:{ all -> 0x0036 }
        r5 = new java.lang.UnsupportedOperationException;	 Catch:{ all -> 0x0036 }
        r6 = "Session: an attempt was made to open a session that has a pending request.";
        r5.<init>(r6);	 Catch:{ all -> 0x0036 }
        r7.postStateChange(r2, r4, r5);	 Catch:{ all -> 0x0036 }
        monitor-exit(r3);	 Catch:{ all -> 0x0036 }
    L_0x001c:
        return;
    L_0x001d:
        r1 = r7.state;	 Catch:{ all -> 0x0036 }
        r2 = $SWITCH_TABLE$com$facebook$SessionState();	 Catch:{ all -> 0x0036 }
        r4 = r7.state;	 Catch:{ all -> 0x0036 }
        r4 = r4.ordinal();	 Catch:{ all -> 0x0036 }
        r2 = r2[r4];	 Catch:{ all -> 0x0036 }
        switch(r2) {
    ...
    L_0x002e:
        r2 = new java.lang.UnsupportedOperationException;	 Catch:{ all -> 0x0036 }
    ...
    L_0x0039:
        ...
        r7.state = r0;	 Catch:{ all -> 0x0036 }
        if (r8 != 0) goto L_0x0047;
    L_0x003f:
        r2 = new java.lang.IllegalArgumentException;	 Catch:{ all -> 0x0036 }
        r4 = "openRequest cannot be null when opening a new Session";
        r2.<init>(r4);	 Catch:{ all -> 0x0036 }
        throw r2;	 Catch:{ all -> 0x0036 }
    L_0x0047:
        r7.pendingAuthorizationRequest = r8;	 Catch:{ all -> 0x0036 }
    L_0x0049:
        if (r8 == 0) goto L_0x0052;
    L_0x004b:
        r2 = r8.getCallback();	 Catch:{ all -> 0x0036 }
        r7.addCallback(r2);	 Catch:{ all -> 0x0036 }
    L_0x0052:
        r2 = 0;
        r7.postStateChange(r1, r0, r2);	 Catch:{ all -> 0x0036 }
        monitor-exit(r3);	 Catch:{ all -> 0x0036 }
    ...
    L_0x0061:
        r2 = r8.getPermissions();	 Catch:{ all -> 0x0036 }
        r2 = com.facebook.internal.Utility.isNullOrEmpty(r2);	 Catch:{ all -> 0x0036 }
        if (r2 != 0) goto L_0x007b;
    L_0x006b:
        r2 = r8.getPermissions();	 Catch:{ all -> 0x0036 }
        r4 = r7.getPermissions();	 Catch:{ all -> 0x0036 }
        r2 = com.facebook.internal.Utility.isSubset(r2, r4);	 Catch:{ all -> 0x0036 }
        if (r2 != 0) goto L_0x007b;
    L_0x0079:
        r7.pendingAuthorizationRequest = r8;	 Catch:{ all -> 0x0036 }
    L_0x007b:
    ...
    private void logAuthorizationStart() {
        ...
        try {
            ...
            extras.put(NativeProtocol.RESULT_ARGS_PERMISSIONS, TextUtils.join(i.b, this.pendingAuthorizationRequest.permissions));
    ...
    private void logAuthorizationComplete(Code result, Map<String, String> resultExtras, Exception exception) {
        Bundle bundle;
        if (this.pendingAuthorizationRequest == null) {
            bundle = AuthorizationClient.newAuthorizationLoggingBundle(i.a);
                    ...
                    synchronized (Session.this.callbacks) {
                        for (final StatusCallback callback : Session.this.callbacks) {
                            ...
                            Session.runWithHandlerOrExecutor(Session.this.handler, new Runnable() {
                                public void run() {
                                    callback.call(Session.this, sessionState, exception);
                                }
                            });
                        }
                    }
