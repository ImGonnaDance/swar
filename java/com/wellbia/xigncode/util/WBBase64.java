...
public class WBBase64 {
    static final /* synthetic */ boolean $assertionsDisabled = (!WBBase64.class.desiredAssertionStatus() ? true : $assertionsDisabled);
    ...
    static class Decoder extends Coder {
        ...
        public Decoder(int i, byte[] bArr) {
            this.output = bArr;
            this.alphabet = (i & WBBase64.URL_SAFE) == 0 ? DECODE : DECODE_WEBSAFE;
            this.state = WBBase64.DEFAULT;
            this.value = WBBase64.DEFAULT;
        }

        public int maxOutputSize(int i) {
            return ((i * 3) / WBBase64.CRLF) + 10;
        }
        ...
        L_0x0133:
            ...
            goto L_0x005d;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.wellbia.xigncode.util.WBBase64.Decoder.process(byte[], int, int, boolean):boolean");
        }
    }
    ...
    static class Encoder extends Coder {
        ...
        static {
            boolean z;
            if (WBBase64.class.desiredAssertionStatus()) {
        ...
        public Encoder(int i, byte[] bArr) {
            ...
            boolean z2 = true;
            this.output = bArr;
            this.do_padding = (i & WBBase64.NO_PADDING) == 0 ? true : $assertionsDisabled;
            if ((i & WBBase64.NO_WRAP) == 0) {
                z = true;
            } else {
                z = $assertionsDisabled;
            }
            this.do_newline = z;
            if ((i & WBBase64.CRLF) == 0) {
                z2 = $assertionsDisabled;
            }
            this.do_cr = z2;
            this.alphabet = (i & WBBase64.URL_SAFE) == 0 ? ENCODE : ENCODE_WEBSAFE;
            this.tail = new byte[WBBase64.NO_WRAP];
            this.tailLen = WBBase64.DEFAULT;
            this.count = this.do_newline ? LINE_GROUPS : -1;
        }

        public int maxOutputSize(int i) {
            return ((i * WBBase64.URL_SAFE) / 5) + 10;
        }
...
*/
        ...
        L_0x023f:
            ...
            goto L_0x0042;
            */
            throw new UnsupportedOperationException("Method not decompiled: com.wellbia.xigncode.util.WBBase64.Encoder.process(byte[], int, int, boolean):boolean");
        }
    }
