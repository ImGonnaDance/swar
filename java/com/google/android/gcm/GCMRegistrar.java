...
public final class GCMRegistrar {
    ...
    public static void checkManifest(Context context) {
        ...
        String permissionName = new StringBuilder(String.valueOf(packageName)).append(".permission.C2D_MESSAGE").toString();
        try {
    ...
    static synchronized void setRetryBroadcastReceiver(Context context) {
        synchronized (GCMRegistrar.class) {
            if (sRetryReceiver == null) {
                ...
                String permission = new StringBuilder(String.valueOf(category)).append(".permission.C2D_MESSAGE").toString();
    ...
    public static String getRegistrationId(Context context) {
        ...
        String registrationId = prefs.getString(PROPERTY_REG_ID, i.a);
    ...
    static String clearRegistrationId(Context context) {
        return setRegistrationId(context, i.a);
    }

    static String setRegistrationId(Context context, String regId) {
        SharedPreferences prefs = getGCMPreferences(context);
        String oldRegistrationId = prefs.getString(PROPERTY_REG_ID, i.a);
